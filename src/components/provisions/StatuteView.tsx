    ...
    <div className="p-5 bg-slate-50 dark:bg-zinc-900/50 rounded-2xl border border-slate-100 dark:border-zinc-800 shadow-[inset_0_1px_2px_rgba(0,0,0,0.02)]">
      ...
      {showTextMap[`n-${p.id}`] && (
        ...
        >
          ...
          <pre className="p-4 bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-xl text-sm text-slate-700 dark:text-zinc-300 whitespace-pre-wrap font-serif leading-relaxed max-h-[400px] overflow-auto shadow-inner">
            {p.fullText}
          </pre>
        </motion.div>
      )}
