...
function RequisitionTable({ project, items, onUpdate, setSelectedRequisitionId }: RequisitionTableProps) {
  ...
  async function handleSeed(scenarioId: string) {
     setIsSeeding(true);
...
function AddRequisitionModal({ isOpen, onClose, projectId, onSuccess, buckets }: { isOpen: boolean, onClose: () => void, projectId: string, onSuccess: () => void, buckets: any[] }) {
...
function SeedScenarioModal({ isOpen, onClose, onSeed }: { isOpen: boolean, onClose: () => void, onSeed: (id: string) => void }) {
